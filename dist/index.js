...
var TaskListHeaderDefault = function TaskListHeaderDefault(_ref) {
  ...
  }, "\xA0Tasks"), React__default.createElement("div", {
    className: styles.ganttTable_HeaderItem,
    style: {
      minWidth: "100px",
      maxWidth: "100px"
...
var Calendar = function Calendar(_ref) {
  ...
  var getCalendarValuesForWeek = function getCalendarValuesForWeek() {
    ...
    var bottomValues = [];
    var weeksCount = 1;
    var topDefaultHeight = headerHeight * 1.25;
    ...
    for (var i = dates.length - 1; i >= 0; i--) {
      ...
      var bottomValue = "" + date.toLocaleDateString('en-US', options);
      var datesArray = [];
      ...
      bottomValues.push(React__default.createElement("text", {
        ...
        className: styles$5.calendarBottomText
      }, " ", bottomValue, React__default.createElement("tspan", {
        x: columnWidth * (i + +rtl) + 10,
        y: headerHeight * 0.8 + 30
      }, datesArray[0]), React__default.createElement("tspan", {
        x: columnWidth * (i + +rtl) + 40,
        y: headerHeight * 0.8 + 30
      }, datesArray[1]), React__default.createElement("tspan", {
        x: columnWidth * (i + +rtl) + 70,
        y: headerHeight * 0.8 + 30
      }, datesArray[2]), React__default.createElement("tspan", {
        x: columnWidth * (i + +rtl) + 110,
        y: headerHeight * 0.8 + 30
      }, datesArray[3]), React__default.createElement("tspan", {
        x: columnWidth * (i + +rtl) + 140,
        y: headerHeight * 0.8 + 30
      }, datesArray[4]), React__default.createElement("tspan", {
        x: columnWidth * (i + +rtl) + 170,
        y: headerHeight * 0.8 + 30
      }, datesArray[5]), React__default.createElement("tspan", {
        x: columnWidth * (i + +rtl) + 210,
        y: headerHeight * 0.8 + 30
      }, datesArray[6])));
...
var TaskItem = function TaskItem(props) {
  ...
  var _useState3 = React.useState(false),
      displayText = _useState3[0],
      setDisplayText = _useState3[1];
  ...
  }, taskItem, displayText != null ? displayText : React__default.createElement("text", {
    x: getX(),
...
var Gantt = function Gantt(_ref) {
  var tasks = _ref.tasks,
      ...
      headerHeight = _ref$headerHeight === void 0 ? 200 : _ref$headerHeight,
