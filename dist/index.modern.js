  ...
  var getCalendarValuesForWeek = function getCalendarValuesForWeek() {
    ...
    for (var i = dates.length - 1; i >= 0; i--) {
      ...
      bottomValues.push(React.createElement("text", {
        ...
        className: styles$5.calendarBottomText
      }, " ", bottomValue, React.createElement("tspan", {
        x: columnWidth * (i + +rtl) + 10,
        y: headerHeight * 0.8 + 30
      }, datesArray[0]), React.createElement("tspan", {
        x: columnWidth * (i + +rtl) + 40,
        y: headerHeight * 0.8 + 30
      }, datesArray[1]), React.createElement("tspan", {
        x: columnWidth * (i + +rtl) + 70,
        y: headerHeight * 0.8 + 30
      }, datesArray[2]), React.createElement("tspan", {
        x: columnWidth * (i + +rtl) + 110,
        y: headerHeight * 0.8 + 30
      }, datesArray[3]), React.createElement("tspan", {
        x: columnWidth * (i + +rtl) + 140,
        y: headerHeight * 0.8 + 30
      }, datesArray[4]), React.createElement("tspan", {
        x: columnWidth * (i + +rtl) + 170,
        y: headerHeight * 0.8 + 30
      }, datesArray[5]), React.createElement("tspan", {
...
var TaskItem = function TaskItem(props) {
  ...
  }, taskItem, displayText != null ? displayText : React.createElement("text", {
    x: getX(),
